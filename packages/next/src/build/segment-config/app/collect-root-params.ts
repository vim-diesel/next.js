...
function collectPageRootParams(
  ...
  while (current) {
    ...
    // This didn't include a root layout, so we need to continue.
 ...
 */
export function collectRootParams({
  routeModule,
...
>): readonly string[] {
  ...
  if (isAppPageRouteModule(routeModule)) {
    return collectPageRootParams(routeModule)
  }
